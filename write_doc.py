...
text = (
    ...
    "- On the Config tab, set Template to the summer template you want (Summer School Week 1+2, or Summer School Week 3, which sends a different email to Jasper vs Allendale schools; run Email Tools then Refresh Template Dropdown once if you do not see it). Then click Email Tools then Generate My Email Drafts. It drafts one email per teacher and per student group for YOUR assigned schools only, each with a two-week data summary and both weekly PDF reports, in your own Gmail Drafts.\n"
