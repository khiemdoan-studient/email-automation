...
text = (
    ...
    "\n"
    "Admin emails now find every school's teachers. The teacher list is read straight from the MAP Master "
    "Roster instead of the copy in this sheet, which was loading only part of the time and mixing up columns "
    "for some schools. That is why a school could come back with 0.0 minutes and 0 teachers. If a school still "
    "comes back empty, the tool now stops and tells you instead of mailing a report full of zeros.\n"
    "\n"
    "Picking a week with no data is now obvious. The confirmation screen says how many of YOUR teachers have "
    "data that week (for example 0 of 3) and lists the weeks that do have their data, with the most recent one "
    "called out. Choosing Yes still generates the emails, just without the data tables, so a run never quietly "
    "produces nothing.\n"
    "\n"
    "When a school's Admin Report PDF was never made for the week you picked, the email now lists the report "
    "dates that do exist for that school.\n"
    "\n"
    "What's New in v2.25.0\n"
    "Three additions.\n"
    "\n"
    "Midweek Snapshot email: pick the Midweek Snapshot template from the dropdown, keep the NORMAL weekly Date "
    "Range, and generate. The tool works out the Thursday-to-Wednesday midweek window on its own. Each teacher "
    "gets a short email with one button that opens their midweek PDF, and clicks show on the Click Dashboard.\n"
    "\n"
    "Short weeks: Generate My Email Drafts first asks how many school days are in the week (leave blank for 5), "
    "then shows the usual confirmation. Pick 4 or 3 for holiday weeks and the green, yellow, red color cutoffs in "
    "the emails shrink to match. The choice applies to that run only.\n"
    "\n"
    "Admin emails: Email Tools then Generate Admin Emails. Three quick questions (which schools by number or ALL, "
    "date range, days in week), and one draft per school lands in YOUR Gmail with the campus average minutes and active days plus a "
    "button to that school's weekly Admin Report. If a school's report was not generated that week, the draft "
    "still comes with the live stats and says the file was not found.\n"
    "\n"
    "What's New in v2.24.1\n"
    "The Click Dashboard got the Student Performance Dashboard look: purple header, color-coded stat cards, "
    "clean tables, and correct dates. Below the charts you'll now find a campus summary with its own chart, "
    "a week-by-link-type table, a Never Clicked follow-up list (teachers who got an email but clicked nothing "
    "in your current filter), and a feed of the 10 most recent clicks.\n"
    "\n"
    "What's New in v2.24.0\n"
    "The Click Dashboard is now live and interactive. Open the Engagement Dashboard tab and use the dropdowns "
    "across the top: Week, Campus, Teacher, and Link type. Every number, table, and chart follows your filters.\n"
    "\n"
    "It tracks every link in the emails, not just the PDF: the weekly video, the infographic, the AIM Launch, "
    "the Timeback login, and the Teacher Hub each count separately.\n"
    "\n"
    "You never rebuild it. New clicks appear on their own, and running Reset Click Data zeroes it on its own. "
    "The Build Click Dashboard menu item exists only to repair the layout if someone breaks the tab.\n"
    "\n"
    "What's New in v2.23.0\n"
    "Three improvements from the first 26-27 test run.\n"
    "\n"
    "Reset the click stats: Email Tools then Engagement: Reset Click Data (archive + zero). "
    "Use it after test runs. It saves the current click history into hidden archive tabs, then zeroes the logs and the dashboard, so only real sends count going forward.\n"
    "\n"
    "Emojis now show in color in the emails instead of gray question-mark diamonds.\n"
    "\n"
    "Links open instantly: clicking a video, infographic, or resource link in an email now goes straight to that page. "
    "Only the weekly report PDF shows a short Studient-branded loading screen before the download starts.\n"
    "\n"
    "What's New in v2.22.0\n"
    "Managers can now edit the 2026-27 weekly emails themselves - no code needed.\n"
    "\n"
    "For managers: the '26_27 Implementation Emails' Google Doc is the source of truth. "
    "Edit a week's tab there (subject line, weekly focus, the checkmark action, the video and infographic links, materials). "
    "Keep the structure the tabs already use: the bold text and the emoji markers are how the system reads the page. "
    ...
    "The data table, color legend, trend note, and the PDF button are fixed parts of the email and cannot be broken from the Doc.\n"
    "\n"
    "What's New in v2.21.0\n"
    "The 2026-27 weekly emails are here: Weeks 1 through 9.\n"
    "\n"
    "On the Config tab, the Template dropdown now starts with the nine new options, "
    "\"26-27 Week 1: Growth Mindset Culture\" through \"26-27 Week 9: Confidence Through Evidence\". "
    "If you do not see them, run Email Tools then Refresh Template Dropdown once. "
    "Pick the week you are sending, pick your data week, then click Generate My Email Drafts as usual.\n"
    "\n"
    "Each of these emails carries your teacher data table, the color legend and trend note, "
    "that week's 60-second video and infographic, the Timeback platform link, and the Teacher Hub. "
    "Weeks 1 through 6 also list the AIM Launch link and the materials you need to gather. "
    "Weeks 7 through 9 point to the Teacher Hub for AIM launches instead.\n"
    "\n"
    "Last year's Week 0-8, Wrap Up, and summer emails are still in the dropdown, further down. "
    "Nothing was removed.\n"
    "\n"
    "What's New in v2.13.0\n"
    "New email: Summer School Week 1+2. This is a separate tool from the weekly dropdown emails.\n"
    "\n"
    "How to send it (same button you always use):\n"
    "- On the Config tab, set Template to the summer template you want (Summer School Week 1+2; Summer School Week 3, which sends a different email to Jasper vs Allendale schools; or Summer School Final Week, a wrap-up for ALL summer schools that also shouts out the students who hit their goals; run Email Tools then Refresh Template Dropdown once if you do not see it). Then click Email Tools then Generate My Email Drafts. It drafts one email per teacher and per student group for YOUR assigned schools only, each with a two-week data summary and both weekly PDF reports, in your own Gmail Drafts.\n"
    "- Summer School: Smoke Test (to me): an all-schools preview that drafts everything to yourself first, if you want a quick look.\n"
    "\n"
    "How it works: the tool reads the summer data dashboard, the MAP master roster, and the Public School Summer Camp Drive folder directly. Where a teacher has an email on file, the draft is addressed to them. Where there is no email (the JRHS groups, or unassigned students), the draft is left with a blank To and a yellow banner so you can fill in the recipient before sending. Each school's Unassigned folder becomes one draft you can re-address by hand.\n"
    "\n"
    "Before sending: run the smoke test, open Gmail Drafts, and confirm the table and the two attached PDFs look right.\n"
    "\n"
    "What\u2019s New in v2.6.0\n"
    "Audit follow-up release \u2014 6 of 6 deferred items addressed.\n"
    "\n"
    "Two new menu items:\n"
    "\u2022 Email Tools \u2192 Test Mode: Generate Smoke Test (drafts to me) \u2014 generates 6-8 sample "
    "drafts to YOUR Gmail (not real teachers) using teachers across all 4 districts. Use this "
    "as a pre-cycle sanity check to verify all template elements render correctly. Open Gmail "
    "Drafts after running to inspect.\n"
    "\u2022 Email Tools \u2192 Retry Last Run\u2019s Failed Teachers \u2014 if any teachers fail in a bulk run, "
    "this opens a modal with checkboxes (one per failed teacher). Pick which to retry. Existing "
    "drafts are deleted before regenerating. Multi-session: works even after closing/reopening "
    "the spreadsheet (state lives in the Error Log via run_id).\n"
    "\n"
    "Behind the scenes: extracted 4 helper functions to eliminate code duplication "
    "(getMySchools, findSchoolFolder, buildSchoolFolderCache, cellToDateString). Color "
    "thresholds and operational limits moved to CONFIG.THRESHOLDS / CONFIG.LIMITS so future "
    "tweaks happen in one place. Test count grew 30 \u2192 45 (+ smoke test as integration cover).\n"
    "\n"
    "Optional: clasp deploy automation. Once you set up clasp (see docs/CLASP_SETUP.md in "
    "the repo), deploy is one command: npm run push. No more copy-paste into the editor. "
    "Manual paste still works as fallback if you skip clasp.\n"
    "\n"
    ...
    "v2.5.x didn't introduce but didn't catch either:\n"
    "\n"
    "\u2022 Aston Haughton (AFMS) was getting an email with no metrics table. Cause: "
    "BigQuery has 'Anton Haughton' (one-letter typo), but roster + Drive folder + email "
    "use 'Aston'. The name-lookup correctly refused the partial match (per the v2.3.1 "
    "cross-teacher data-leak guard). Fix: added a temporary NAME_ALIASES entry mapping "
    "'aston haughton' \u2192 'anton haughton' until the SIS / BQ data is corrected. Also "
    "added a permanent alias for 'lakieshie jennings' \u2192 'lakieshie roberts-jennings' (JHES, "
    "hyphenated last name in metrics).\n"
    "\n"
    "\u2022 'Debug: Check Teacher Folders' was showing every teacher as MISSING in red text. "
    "Cause: the diagnostic searched for the UNDERSCORED folder name ('Aston_Haughton') but "
    "actual Drive folders use SPACES ('Aston Haughton'). Pre-existing bug since the Drive "
    "structure rolled out (v2.0.3 era). Fix: now checks both forms.\n"
    "\n"
    "New menu item: Email Tools \u2192 Debug: Check Teacher Names. Pre-flight roster vs metrics "
    "alignment check. Run this BEFORE generating drafts to see if any teachers will get the "
    "'No metrics rows found' callout, with hints about which metrics-tab name might be a "
    "typo of which roster name. Use this whenever a draft email shows a missing-metrics callout.\n"
    "\n"
    "Comprehensive validation: ran the new scanner against the full roster for week 2026-04-20. "
    "Result: 75 of 86 teachers will now get metrics in their emails (was 73 before aliases). "
    "Remaining 11 are upstream gaps \u2014 teachers in roster but absent from BigQuery \u2014 needs "
    "data-team escalation. List of 10 missing-from-BQ teachers (mostly JRES + Kim Bell at Reading) "
    "is documented in the v2.5.2 CHANGELOG entry.\n"
    "\n"
