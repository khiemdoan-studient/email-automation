...
text = (
    ...
    "Three additions.\n"
    "\n"
    "Midweek Snapshot email: pick the Midweek Snapshot template from the dropdown, set the Date Range to the "
    "midweek window (for example 2026-03-05_to_2026-03-11), and generate. Each teacher gets a short email with "
    "one button that opens their midweek PDF. Clicks show up on the Click Dashboard like everything else.\n"
    "\n"
    "Short weeks: Generate My Email Drafts now opens a small window with the run details and a Days in this "
    "school week choice (default 5). Pick 4 or 3 for holiday weeks and the green, yellow, red color cutoffs in the "
    "emails shrink to match. The choice applies to that run only.\n"
    "\n"
    "Admin emails: Email Tools then Generate Admin Emails. Check the schools you want, confirm the date range and "
    "days, and one draft per school lands in YOUR Gmail with the campus average minutes and active days plus a "
