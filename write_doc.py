...
text = (
    "Email Automation\n"
    "User Guide & Documentation (v2.10.0)\n"
    "\n"
    "What Is This?\n"
    ...
    "\n"
    "Two new menu items under Email Tools:\n"
    "- Generate Summer School Drafts (Wk 1+2): drafts one email per summer-school teacher (and per student group), each with a two-week data summary and both weekly XP-report PDFs attached. Drafts land in YOUR Gmail.\n"
    "- Summer School: Smoke Test (to me): the same run, but every draft goes to you for a quick visual check first.\n"
    "\n"
