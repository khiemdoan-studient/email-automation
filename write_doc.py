...
text = (
    "Email Automation\n"
    "User Guide & Documentation (v2.11.0)\n"
    "\n"
    "What Is This?\n"
    ...
    "- On the Config tab, set Template to Summer School Week 1+2 (run Email Tools then Refresh Template Dropdown once if you do not see it). Then click Email Tools then Generate My Email Drafts. It drafts one email per teacher and per student group for YOUR assigned schools only, each with a two-week data summary and both weekly PDF reports, in your own Gmail Drafts.\n"
